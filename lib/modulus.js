...
//            }
    ...
    _rewriteAModulesContentsToUseExplicitDefines: function(module){
        ...
        if(modulusCallIndex >=0){
            ...
            var metadataIndex = contents.indexOf(module.name+'.module');
            if(metadataIndex >=0){
                var newContent = '\n;'+module.name+'.module.name = "'+module.name+'";'+
                                 '\n'+module.name+'.module.deps = '+JSON.stringify(module.dependencies)+';';
                contents = contents + newContent;
            }else{
                var newContent = '\n;'+module.name+'.module = {name:"'+module.name+'", deps:' +JSON.stringify(module.dependencies)+'};';
                contents = contents + newContent;
            }
        }
