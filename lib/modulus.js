...
//            }
     ...
     * TODO: handle namespaced version. e.g. ns.moduleA = fucntion(dep1, dep2){...}
    ...
    _rewriteAModulesContentsToUseExplicitDefines: function(module){
        ...
        var modulusCallIndex = contents.indexOf('modulus(function');
        var mCallIndex = contents.indexOf('m(function');

        if(modulusCallIndex >=0){
            var newContent = 'modulus("' + module.name + '",'+JSON.stringify(module.dependencies)+', function';
            contents = contents.replace('modulus(function', newContent);
        }else if(mCallIndex >=0){
            var newContent = 'm("' + module.name + '",'+JSON.stringify(module.dependencies)+', function';
            contents = contents.replace('m(function', newContent);
        }else{
